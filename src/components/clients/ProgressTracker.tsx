    ...
    <Box className='w-full'>
      <Card shadow='sm' padding='md' radius='lg' withBorder mb='md'>
        <Flex
          ...
          align='center'
          direction={{ base: 'column', sm: 'row' }} // Stack on mobile, row on desktop
          gap={{ base: 'md', sm: 0 }} // Add gap between stacked items on mobile
        >
          <Flex align='center' gap='lg' w={{ base: '100%', sm: 'auto' }}>
            <CustomRingProgress
              size={150}
              thickness={10}
              roundCaps
          ...
          <Button
            leftSection={<img src={previewEyeIcon} alt='Preview' width={16} />}
            color='#1D9B5E'
            radius='md'
            size='md'
            onClick={() => {
      ...
      <Card shadow='sm' radius='lg' withBorder p='0'>
        ...
        >
          ...
          <Flex
            ...
            p='md'
            style={{ flex: 1 }}
            display={{ base: 'none', sm: 'flex' }} // Hide on mobile (merge into green section)
          >
            <Text size='2rem' fw={500}>
              12
              <Text component='span' size='1rem' c='dimmed' fw={500}>
          ...
          {/* Mobile-Only Merged Sections (Assessments + Absences) */}
          <Flex
            display={{ base: 'flex', sm: 'none' }} // Show only on mobile
            justify='space-between'
            w='100%'
            px='md'
            pb='lg'
          >
            ...
            <Flex direction='column' align='center' pos='relative' mt='xl'>
              <Text size='2rem' fw={500}>
                1
              </Text>
              <Text size='xs' c='dimmed'>
              ...
              <Button
                ...
                styles={{
                  ...
                  root: { position: 'absolute', top: -40, right: -10 },
                }}
              >
                Attendance
              </Button>
